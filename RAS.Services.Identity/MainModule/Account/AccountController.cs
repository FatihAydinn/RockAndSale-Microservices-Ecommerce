...
using RAS.Services.Identity.MainModule.Account;
using RAS.Services.Identity.MainModule.Account;
using RAS.Services.Identity.Models;
using RAS.Services.Identity;
...
namespace IdentityServerHost.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            //var userr = await _userManager.FindByEmailAsync(model.Username);
            //if (userr != null)
            //{
            //    if (!await _userManager.IsEmailConfirmedAsync(userr))
            //    {
        ...
        public async Task<IActionResult> Register(string returnUrl)
        {
            ...
            var vm = await BuildRegisterAsync(returnUrl);
        ...
        //[AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Register(Register.InputModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //var subject = "Kayýt Bilgilendirmesi";
                    //var message = "Sn. "+user.FirstName+" "+user.LastName+"\nRockAndSale Kaydýnýz baþarýyla gerçekleþmiþtir.";
                    //var recipient = user.Email;

                    var emailSender = new EmailSender();
                    await emailSender.SendEmailAsync(model.Email, "Hesap Doðrulamasý",
                        $"Lütfen hesabýnýzý doðrulamak için linke týklayýn: \n{callbackUrl}");
                    ...
                    //catch (Exception ex)
                    //{
                    //    ModelState.AddModelError("", "E-posta gönderimi baþarýsýz oldu. Lütfen daha sonra tekrar deneyin.");
                    //    user.EmailConfirmed = false;
                    //}

                    //var isEmailSent = await _emailSender.SendEmailAsync(recipient, subject, message);
        ...
        private async Task<Register.InputModel> BuildRegisterAsync(string returnUrl)
        {
            ...
            if (context?.IdP != null && await _schemeProvider.GetSchemeAsync(context.IdP) != null)
            {
                ...
                var vm = new Register.InputModel
                {
            ...
            return new Register.InputModel
            {
...
//            return View(model);
//        }
//        private async Task<Register> BuildRegisterAsync(string returnUrl)
//        {
//            var context = await _interaction.GetAuthorizationContextAsync(returnUrl);
//            List<string> roles = new List<string>();
//            roles.Add("Admin");
